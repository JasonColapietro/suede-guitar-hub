...
export default function PrivacyPage() {
  return (
    <Article eyebrow="GuitarHub" title="Privacy Policy" dek="Your playing stays on your device. Here is what the app and website use, save, and send." updated="2026-09-20" showPracticeCallToAction={false}>
      ...
      <p>When you choose to record a take in a voice lesson on guitarhub.org, the website saves one optional recording of up to two minutes for that lesson in this browser’s IndexedDB storage under the current signed-in account or guest scope so you can play it back. It replaces the previous browser take for that lesson within that scope, is never uploaded or synced, and does not score your singing or complete the lesson. You can delete it from the lesson after confirming the deletion. Clearing this site’s browser data also removes it, and GuitarHub cannot access or recover it.</p>
