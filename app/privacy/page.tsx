...
export default function PrivacyPage() {
  return (
    <Article eyebrow="GuitarHub" title="Privacy Policy" dek="Your playing stays on your device. Here is what the app and website use, save, and send." updated="2026-09-20" showPracticeCallToAction={false}>
      ...
      <p>Local records remain until you clear the relevant website data or remove the app’s stored data. Browser settings, device backups, and operating-system restore features can affect how long a copy of these learning records remains; optional lesson recordings are excluded from device backups as described above. Synced lesson-attempt evidence remains under your account until you delete its cloud practice history or request account deletion. Clearing local or cloud records may be irreversible. Export tools, where offered, save a file you control.</p>
