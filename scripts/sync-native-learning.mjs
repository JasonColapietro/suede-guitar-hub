...
const mappings = ['guitar', 'voice', 'song-guitar', 'beginner-guitar-instruction', 'song-guitar-instruction', 'advanced-guitar-instruction', 'voice-instruction', 'voice-learning-material'].map(name => [`GuitarHubCore/Sources/GuitarHubCore/Resources/${name}.json`, `lib/learning/data/${name}.json`]);
